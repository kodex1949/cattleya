            ...
            <div className="relative flex max-h-[calc(100dvh-104px)] flex-col overflow-hidden px-5 pb-5 pt-5">
              ...
              <div className="mt-6">
                <div className="flex h-14 items-center gap-3 rounded-full border border-white/10 bg-white/[0.045] px-4 backdrop-blur-xl">
                  ...
                  <input
                    ...
                    className="h-full flex-1 bg-transparent text-[16px] font-light tracking-[-0.02em] text-white placeholder:text-white/28 outline-none"
                    autoComplete="off"
                    inputMode="search"
                  />
                  ...
                  {searchQuery ? (
                    ...
                    >
                      <X size={12} weight="thin" className="text-white/60" />
                    </button>
                  ) : null}
                </div>
              </div>
              ...
              <div className="mt-7 flex-1 overflow-y-auto pr-1">
                {!hasQuery && (
                  <>
                    <div>
                      <SearchSectionHeader title="Parcourir les notes" />
                      ...
                      <div className="flex gap-3 overflow-x-auto pb-2">
                        {curatedSearches.map((item) => (
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              setSearchQuery(item.subtitle.split(" · ")[0])
                            }
